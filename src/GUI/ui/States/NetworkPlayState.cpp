...
NetworkPlayState::NetworkPlayState(SOCKET socket, StateMachine& machine, sf::RenderWindow& window, gui::World& world, utils::TextureManager& texture_manager, const bool replace)
    : State(machine, window, replace), _socket(socket), _world(world), _textureManager(texture_manager) {
